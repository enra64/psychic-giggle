...
public class SensorData implements Serializable, Cloneable, Externalizable {
    ...
    /**
     * Data contained in this instance. Depends on the sensor type, see <a href="https://developer.android.com/reference/android/hardware/SensorEvent.html#values">android docs</a>.
     */
    public float[] data = null;

    /**
     * The android <a href="https://developer.android.com/reference/android/hardware/SensorEvent.html#timestamp">timestamp</a> of the sensor data (in ns)
     */
     ...
     * @param data       the data that was generated by the sensor. Depends on the sensor type, see <a href="https://developer.android.com/reference/android/hardware/SensorEvent.html#values">android docs</a>.
     * @param timestamp  the android <a href="https://developer.android.com/reference/android/hardware/SensorEvent.html#timestamp">timestamp</a> of the sensor data (in ns)
     */
