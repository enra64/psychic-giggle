...
/**
 * {@link DataSource} feeding linear acceleration data
 */
public class LinearAcceleration extends AbstractSensor {
    /**
     * Create an LINEAR_ACCELERATION sensor; does not start anything yet, use {@link #start()} or {@link #setRunning(boolean)}
     * to start receiving events
     *
     * @param context android system context needed for sensors
     */
    public LinearAcceleration(Context context) {
        super(context, Sensor.TYPE_LINEAR_ACCELERATION, SensorType.LinearAcceleration);
    }
