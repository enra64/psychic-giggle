...
public class Light extends AbstractSensor {
    ...
    public Light(Context context) {
        super(context, Sensor.TYPE_LIGHT, SensorType.Light);
    }

    /**
     * Static sensor speed definition for all{@link Light} instances. defaults to sensor_delay_game.
     */
    private static SetSensorSpeed.SensorSpeed mSensorSpeed = SetSensorSpeed.SensorSpeed.SENSOR_DELAY_GAME;

    /**
     * update the sensor speed for all{@link Light} instances
     *
    ...
    /**
     * Get the sensor speed currently set for all {@link Light} instances
     */
    @Override
