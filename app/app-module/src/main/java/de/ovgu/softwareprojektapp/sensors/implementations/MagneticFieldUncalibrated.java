...
class MagneticFieldUncalibrated extends AbstractSensor {
     ...
     */
    public MagneticFieldUncalibrated(Context context) {
        super(context, Sensor.TYPE_MAGNETIC_FIELD_UNCALIBRATED, SensorType.MagneticFieldUncalibrated);
    }

    /**
     * Static sensor speed definition for all{@link MagneticFieldUncalibrated} instances. defaults to sensor_delay_game.
     */
    private static SetSensorSpeed.SensorSpeed mSensorSpeed = SetSensorSpeed.SensorSpeed.SENSOR_DELAY_GAME;

    /**
     * update the sensor speed for all{@link MagneticFieldUncalibrated} instances
     *
    ...
    /**
     * Get the sensor speed currently set for all {@link MagneticFieldUncalibrated} instances
     */
    @Override
